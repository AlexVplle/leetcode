...
class Solution:
    def minTimeToReach(self, moveTime: List[List[int]]) -> int:
        ...
        while priority_queue:
            time, x, y, time_move = heapq.heappop(priority_queue)
            ...
            for dx, dy in directions:
                ...
                if 0 <= new_x < row and 0 <= new_y < col and moveTime[new_x][new_y] != -1:
                    ...
                    if distances[new_x][new_y] > time_n + time_move:
                        distances[new_x][new_y] = time_n + time_move
                        heapq.heappush(priority_queue, (time_n + time_move, new_x, new_y, time_move % 2 + 1))
